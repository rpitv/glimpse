<template>
	<div class="containerLowerThird">
		<div
			:class="{show: replicants.lowerThird.endGraphics.show.value, hide: !replicants.lowerThird.endGraphics.show.value}">
			<EndGraphics/>
		</div>
...
import Locator from "../rpitv-modern/lower-third/Locator.vue";
