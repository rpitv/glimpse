<template>
	...
	<div class="logo" id="leftLogo">
		<img :src="replicants.lowerThird.scoreboard.leftTeam.logo.value" :alt="replicants.teams[0].name.value">
	</div>
	<div class="logo" id="rightLogo">
		<img :src="replicants.lowerThird.scoreboard.rightTeam.logo.value" :alt="replicants.teams[1].name.value">
	</div>
