	...
	return {
		...
		lowerThird: {
          ...
          rightTeam: {
            ...
            bottomTextBar: {
                show: await replicant<boolean>("show", `glimpse-graphics.images.bottomTextBar`, {defaultValue: false}),
                greyText: {
                    text: await replicant<string>('text', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: ""}),
                    alignment: await replicant<"left" | "center" | "right">('alignment', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: "center"}),
                    show: await replicant<boolean>("show", `glimpse-graphics.images.bottomTextBar.greyText`, {defaultValue: false}),
                    textSize: await replicant<number>('textSize', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: 0}),
                    offsetX: await replicant<number>('offsetX', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: 0}),
                    offsetY: await replicant<number>('offsetY', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: 0}),
                    textColor: await replicant<string>('textColor', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: ""}),
                    bgColor: await replicant<string>('bgColor', 'glimpse-graphics.bottomTextBar.greyText', {defaultValue: ""}),
                },
                redText: {
                    text: await replicant<string>('text', 'glimpse-graphics.bottomTextBar.redText', {defaultValue: ""}),
                    alignment: await replicant<"left" | "center" | "right">('alignment', 'glimpse-graphics.bottomTextBar.redText', {defaultValue: "center"}),
                    show: await replicant<boolean>("show", `glimpse-graphics.images.bottomTextBar.redText`, {defaultValue: false}),
                    textSize: await replicant<number>('textSize', 'glimpse-graphics.bottomTextBar.redText', {defaultValue: 0}),
                    offsetX: await replicant<number>('offsetX', 'glimpse-graphics.bottomTextBar.redText', {defaultValue: 0}),
                    offsetY: await replicant<number>('offsetY', 'glimpse-graphics.bottomTextBar.redText', {defaultValue: 0}),
                    textColor: await replicant<string>('textColor', 'glimpse-graphics.bottomTextBar.redText', {defaultValue: ""}),
                    autoResize: await replicant<boolean>("autoResize", `glimpse-graphics.images.bottomTextBar.redText`, {defaultValue: false}),
                },
            },
