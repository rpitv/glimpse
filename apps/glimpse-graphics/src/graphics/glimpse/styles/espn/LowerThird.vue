<template>
	<body :class="{show: replicants.lowerThird.scoreboard.value, hide: !replicants.lowerThird.scoreboard.value}">
		<img :src="lowerthird" alt="lower_third">
...
import lowerthird from "../../../../lowerthird.png";
