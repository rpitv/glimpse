...
export type ContactSubmissionDetailsQuery = { __typename?: 'Query', submissionDetails?: { __typename?: 'ContactSubmission', id?: any | null, name?: string | null, email?: string | null, additionalData?: any | null, timestamp?: any | null, subject?: string | null, resolved?: boolean | null, body?: string | null } | null };
...
export type CreateContactSubmissionMutationVariables = Exact<{
  data: CreateContactSubmissionInput;
}>;


export type CreateContactSubmissionMutation = { __typename?: 'Mutation', contactSubmission: { __typename?: 'ContactSubmission', id?: any | null } };
...
export type FindContactSubmissionsQuery = { __typename?: 'Query', totalSubmissions: number, contactSubmissions: Array<{ __typename?: 'ContactSubmission', id?: any | null, name?: string | null, email?: string | null, resolved?: boolean | null, subject?: string | null, timestamp?: any | null }> };
...
export type ResolveContactSubmissionMutationVariables = Exact<{
  id: Scalars['BigInt'];
  resolve: Scalars['Boolean'];
}>;


export type ResolveContactSubmissionMutation = { __typename?: 'Mutation', submission: { __typename?: 'ContactSubmission', id?: any | null } };
...
export const CreateContactSubmissionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateContactSubmission"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateContactSubmissionInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"contactSubmission"},"name":{"kind":"Name","value":"createContactSubmission"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateContactSubmissionMutation, CreateContactSubmissionMutationVariables>;
...
export const ResolveContactSubmissionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ResolveContactSubmission"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BigInt"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resolve"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"submission"},"name":{"kind":"Name","value":"updateContactSubmission"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"resolved"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resolve"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<ResolveContactSubmissionMutation, ResolveContactSubmissionMutationVariables>;
